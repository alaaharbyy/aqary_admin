...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/dashboard/auction/createAuction": {
            "post": {
                ...
                "description": "This API is responsible to create a auction, it also save address and property informations",
                "consumes": [
                    "application/json"
                ],
                "produces": [
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "integer",
                        "description": "exhibition type: 1-exhibition , 2-trade show , 3-conference , 4- workshops 5-training",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "integer",
                        "description": "1 for image , 2 for brochure , 3 for video , 4 for promotion video",
                        "name": "file_no",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/api/project-share/phases-shared-with-me": {
            "get": {
                ...
                "description": "Retrieve all project phases that have been shared with the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/project-share/properties-shared-with-me": {
            "get": {
                ...
                "description": "Retrieve all project properties that have been shared with the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/project-share/property-units-shared-with-me": {
            "get": {
                ...
                "description": "Retrieve all project property units that have been shared with the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/project-share/shared-with-me": {
            "get": {
                ...
                "description": "Retrieve all projects that have been shared with the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/publish-project/properties": {
            "get": {
                ...
                "description": "Retrieve all published project properties for the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/publish-project/property-units": {
            "get": {
                ...
                "description": "Retrieve all published project property units for the authenticated user",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "aqary_admin_internal_domain_requests_project.CreateProjectRequest": {
            ...
            "properties": {
                "amenities_id": {
                    "description": "@ AmenitiesID is the list of amenity IDs associated with the project.",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "branch_developer_company_id": {
                    "description": "@ BranchDeveloperCompanyID is the ID of the branch developer company.                                    // @ RefNumber is the reference number of the project.",
                    "type": "integer"
                },
                "built_up_area": {
                ...
                "community": {
                    "description": "@ CommunityID is the ID of the community where the project is located.",
                    "type": "integer"
                },
                "completion_date": {
                ...
                "completion_percentage": {
                    "description": "@ CompletionPercentage denotes the completion percentage of the project.",
                    "type": "integer"
                },
                "completion_percentage_date": {
                    "description": "@ CompletionPercentageDate is the date when the completion percentage was last updated.",
                    "type": "string"
                },
                "completion_status": {
                ...
                "facilities_id": {
                    "description": "Lat                      float64 ` + "`" + `form:\"lat\" binding:\"required\"` + "`" + `                         // @ Lat is the latitude of the project location.\nLng                      float64 ` + "`" + `form:\"lng\" binding:\"required\"` + "`" + `                         // @ Lng is the longitude of the project location.",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "is_multiphase": {
                    "description": "@ IsMultiPhase is the boolean to check whether the project is multi-phase or not.",
                    "type": "boolean"
                },
                "license_no": {
                ...
                "life_style": {
                    "description": "@ Lifestyle represents the lifestyle features associated with the property.",
                    "type": "integer"
                },
                "no_of_properties": {
                ...
                "parent_developer_company_id": {
                    "description": "@ ParentDeveloperCompanyID is the ID of the parent developer company.",
                    "type": "integer"
                },
                "plot_area": {
                ...
                "service_charge": {
                    "description": "@ ServiceCharge represents the service charge associated with the property.",
                    "type": "integer"
                },
                "start_date": {
                ...
                "sub_community": {
                    "description": "@ SubCommunityID is the ID of the sub-community where the project is located.",
                    "type": "integer"
                },
                "unit_of_measure": {
                    "type": "string"
        ...
        "aqary_admin_internal_domain_requests_user.CreateUserReq": {
            ...
            "properties": {
                ...
                "country_id": {
                    "description": "Locations []int64 ` + "`" + `form:\"locations\"` + "`" + `\nlocation",
                    "type": "integer"
                },
                "department_id": {
                    "type": "integer"
        ...
        "aqary_admin_pkg_utils_exceptions.ErrorMessage": {
            ...
            "enum": [
                ...
                "One auction already exist with the same auction title, Please create a diffrent title",
