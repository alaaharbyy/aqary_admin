...
ALTER SEQUENCE countries_id_seq RESTART WITH 8;

ALTER TABLE countries
ADD COLUMN name varchar NOT NULL DEFAULT '',
ADD COLUMN numcode bigint NULL;

ALTER TABLE countries 
ALTER COLUMN name DROP DEFAULT,
ALTER COLUMN flag DROP NOT NULL;

INSERT INTO countries (alpha2_code, name, country, alpha3_code, numcode, country_code) 
VALUES
...
UPDATE countries SET flag = '' WHERE flag IS NULL;

ALTER TABLE countries ALTER COLUMN flag SET NOT NULL;

UPDATE countries SET country = 'United Kingdom' WHERE id = 7;
