...
const filterCountLuxuryProperty = `-- name: FilterCountLuxuryProperty :many
With x As(
...
type FilterCountLuxuryPropertyParams struct {
...
func (q *Queries) FilterCountLuxuryProperty(ctx context.Context, arg FilterCountLuxuryPropertyParams) ([]int64, error) {
	rows, err := q.db.Query(ctx, filterCountLuxuryProperty,
		arg.CountriesID,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
const filterLuxuryProperties = `-- name: FilterLuxuryProperties :many
With x As(
...
type FilterLuxuryPropertiesParams struct {
	CountriesID pgtype.Int8 `json:"countries_id"`
	Column2     []int64     `json:"column_2"`
	Column3     pgtype.Text `json:"column_3"`
	Column4     pgtype.Text `json:"column_4"`
...
type FilterLuxuryPropertiesRow struct {
	ID                  int64       `json:"id"`
...
func (q *Queries) FilterLuxuryProperties(ctx context.Context, arg FilterLuxuryPropertiesParams) ([]FilterLuxuryPropertiesRow, error) {
	rows, err := q.db.Query(ctx, filterLuxuryProperties,
		arg.CountriesID,
		arg.Column2,
		arg.Column3,
		arg.Column4,
	...
	defer rows.Close()
	var items []FilterLuxuryPropertiesRow
	for rows.Next() {
		var i FilterLuxuryPropertiesRow
		if err := rows.Scan(
			&i.ID,
			&i.PropertyTitle,
			&i.PropertyName,
